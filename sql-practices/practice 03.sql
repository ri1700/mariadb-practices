...
select a.last_name as 's로 시작하는 이름', c.dept_name as '부서명', d.title as '직책'
...
select concat(a.first_name, ' ', a.last_name) as '급여가 40000 이상인 사원', b.salary as '급여'
...
select c.title as '직책', avg(b.salary) as '평균 연봉'
	from employees a, salaries b, titles c
		where a.emp_no = b.emp_no
			and a.emp_no = c.emp_no
			and b.to_date = '9999-01-01'
